package mod.modid.platforms.core.registries;
...
public interface ICustomRegistry<T extends ICustomRegistryEntry>
{
    ...
    /**
     * Builder specifications for creating new mod registries.
     *
    ...
    interface Builder<T extends ICustomRegistryEntry> {
         ...
         */
        static <T extends ICustomRegistryEntry> ICustomRegistry.Builder<T> simple()
        {
