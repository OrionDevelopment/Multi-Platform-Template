package mod.modid.forge.platform.registry.registrar.delegates;
...
public class ForgeRegistryObjectPlatformDelegate<T extends IForgeRegistryEntry<? super T>> implements IRegistryObject<T>
{
